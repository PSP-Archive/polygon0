...
#define F_sceGumMatrixMode
#define F_sceGumLoadIdentity
#define F_sceGumPerspective
#define F_gumPerspective
#define F_sceGumMultMatrix
#define F_gumMultMatrix
#define F_sceGumTranslate
#define F_sceGumRotateXYZ
#define F_sceGumRotateX
#define F_sceGumRotateY
#define F_sceGumRotateZ
#define F_sceGumDrawArray
#define F_sceGumUpdateMatrix

#define F_gumTranslate
#define F_gumRotateX
#define F_gumRotateY
#define F_gumRotateZ
...
void gumLoadIdentity(ScePspFMatrix4* m)
{
	...
	_memset(m,0,sizeof(ScePspFMatrix4));
...
void sceGumOrtho(float left, float right, float bottom, float top, float near, float far)
{
	...
	_memset(t,0,sizeof(ScePspFMatrix4));
